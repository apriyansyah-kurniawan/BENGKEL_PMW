...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['sparepart']) && is_array($_POST['sparepart']) && count($_POST['sparepart']) > 0) {
        ...
        foreach ($_POST['sparepart'] as $id_layanan) {
            $sql = "INSERT INTO pemesanan (id_pelanggan, id_sparepart,tanggal_pemesanan) VALUES ('$id_pelanggan', '$id_layanan','$tanggal_pemesanan')";
        ...
        header("Location: input_sparepart.php"); // Replace 'success_page.php' with the desired destination page
        exit;
    } else {
